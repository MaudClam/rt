...
# define LIGHTS_GLOWING_FACTOR		4
...
# define OUTLINE_WIDTH 				0.01f
# define MATTNESS_GLOSSY_LIMIT		0.3f
# define MATTNESS_GLOSSY_RATIO		1

# define MAX_PHOTONS_NUMBER			1e+6
# define MIN_ESTIMATE_PHOTONS		10
# define MAX_ESTIMATE_PHOTONS		100
# define MAX_PHOTON_COLLISIONS		1000
# define MAX_PHOTONS_GRID_STEP		1.0f
# define TOTAL_PHOTONS_POWER		1.0f
# define PHOTON_SURVIVAL			1.0f
# define CONE_FILTER_COEFFICIENT	10.0f
